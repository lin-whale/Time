...
import com.example.time.ui.timeRecord.MinimalExampleContent
import com.example.tiptime.ui.theme.TimeTheme

class ShowIntroductionActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Box(Modifier.safeDrawingPadding()) {
                showIntroduction(viewModel = lifePieceViewModel)
            }
        }
    }
}
...
@RequiresApi(Build.VERSION_CODES.O)
@Composable
fun showIntroduction(viewModel: TimeViewModel){
